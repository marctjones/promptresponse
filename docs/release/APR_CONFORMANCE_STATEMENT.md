# APR 1.0-beta.7 Implementation Conformance Statement
...
| [APR-MODEL-033](../APR_SPECIFICATION.md#submission) | MUST | Send the document as the body of one `PUT` to a `put` entry, with the `vnd.apr` media type of its representation as `Content-Type` ([Document type](../APR_SPECIFICATION.md#media-types)) — **MUST** | |
...
| [APR-MODEL-134](../APR_SPECIFICATION.md#submission) | MUST | A reader **MUST** read a string entry as an object whose `kind` is `put` and whose `url` is that string. | |
...
| [APR-MODEL-138](../APR_SPECIFICATION.md#submission) | SHOULD | A writer **SHOULD** name the stored object by the form's semantic digest, as `submissions/` followed by the digest ([Digests](../APR_SPECIFICATION.md#digests)). | |
...
| [APR-TEXT-004](../APR_SPECIFICATION.md#filled-never-rewritten) | MUST | A validator **MUST** report a warning, `RESPONSE_FORBIDDEN_CODE_POINT` ([Warnings](../APR_SPECIFICATION.md#warnings)), for a response that contains a code point [Human-facing text](../APR_SPECIFICATION.md#human-text) excludes, other than a carriage return (U+000D). | |
...
| [APR-VAL-036](../APR_SPECIFICATION.md#warnings) | MUST | `RESPONSE_FORBIDDEN_CODE_POINT` — A response carries a code point the floor excludes, other than a carriage return ([Human-facing text](../APR_SPECIFICATION.md#human-text)). — **MUST** | |
...
| [APR-MODEL-064](../APR_SPECIFICATION.md#metadata) | OPTIONAL | `submissionUrls` — array of string or object — **OPTIONAL** — Ordered delivery choices, each `https` or `mailto` ([Submission targets](../APR_SPECIFICATION.md#submission)). | |
...
| [APR-MODEL-128](../APR_SPECIFICATION.md#submission) | REQUIRED | `kind` — string — **REQUIRED** — `put` or `post`. | |
| [APR-MODEL-129](../APR_SPECIFICATION.md#submission) | REQUIRED | `url` — string — **REQUIRED** — The target the request is sent to, used verbatim, query string included. | |
| [APR-MODEL-130](../APR_SPECIFICATION.md#submission) | OPTIONAL | `fields` — object — **OPTIONAL** — The policy fields a `post` target requires, each sent verbatim. | |
| [APR-MODEL-131](../APR_SPECIFICATION.md#submission) | OPTIONAL | `expires` — string — **OPTIONAL** — An RFC 3339 instant after which the grant is spent. | |
| [APR-MODEL-132](../APR_SPECIFICATION.md#submission) | OPTIONAL | `refresh` — string — **OPTIONAL** — A URL that issues a replacement entry, described below. | |
| [APR-MODEL-133](../APR_SPECIFICATION.md#submission) | MUST | A `submissionUrls` entry **MUST** be a string or an object. | |
| [APR-MODEL-135](../APR_SPECIFICATION.md#submission) | MUST | A `post` entry **MUST** carry `fields`. | |
...
| [APR-ATTEST-002](../APR_SPECIFICATION.md#attestation-catalogue) | REQUIRED | `aprVersion` — string — **REQUIRED** — `1.0-beta.7`, or `1.0-beta.6` ([Version compatibility](../APR_SPECIFICATION.md#version-compatibility)). | |
