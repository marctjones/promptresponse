...
{
    /// <summary>
    /// Puts the submission URL list on the document and then signs it.
    /// </summary>
    /// <remarks>
    /// The publisher payload binds <c>metadata.submissionUrls</c> — the field a
    ...
    {
        document.Metadata.SubmissionUrls = url is null ? null : [url];
